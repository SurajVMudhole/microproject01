        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
          <div class="user-details">
            ...
            <div class="input-box">
              ...
              <input type="text" name="name" placeholder="Enter  name" oninput="convertToUppercase()" required>
            </div>
            <div class="input-box">
            ...
            <div class="input-box">
              ...
              <input type="text" name="father" placeholder="Enter  Father name" oninput="convertToUppercase()" required>
            </div>
            <div class="input-box">
              <span class="details">Mother name</span>
              <input type="text" name="mother" placeholder="Enter Mother name" oninput="convertToUppercase()" required>
            </div>
            <div class="input-box">
              <span class="details">Phone number</span>
              <input type="text" name="phone" placeholder="Enter Phone number" oninput="convertToUppercase()"  required>
            </div>
            <div class="input-box">
              <span class="details">Email</span>
              <input type="email" name="email" placeholder="Enter Email" oninput="convertToUppercase()"  required>
            </div>
            <div class="input-box">
              <span class="details">Addmission Number</span>
              <input type="text" name="admission" placeholder="Provide Addmission number" oninput="convertToUppercase()"  required>
            </div>
            <div class="input-box">
